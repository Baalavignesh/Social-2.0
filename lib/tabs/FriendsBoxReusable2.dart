...
Container friendsBoxRequest(FaIcon profilePic, String uFriend, String uDistrict,
    String uState, String uCategory, BuildContext context, bool received) {
  return Container(
    child: Padding(
      ...
      child: GestureDetector(
        onTap: () {
          print(uNearMeName);
          print(uNearMeName.indexOf(uFriend));
